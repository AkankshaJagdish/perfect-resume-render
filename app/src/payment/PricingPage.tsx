...
const bestDealPaymentPlanId: PaymentPlanId = PaymentPlanId.Starter;
    ...
    <div className="py-10 lg:mt-10">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <p className="text-muted-foreground mx-auto mt-6 max-w-2xl text-center text-lg leading-8">
          Start with one free generation, then subscribe to Starter for 10
          optimized resumes per month.
        </p>
        {errorMessage && (
        ...
        <div className="isolate mx-auto mt-16 grid max-w-md grid-cols-1 gap-y-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-1 lg:gap-x-8">
            ...
            >
              ...
              <CardFooter>
                {isUserSubscribed ? (
                  ...
                  >
                    {user ? "Subscribe to Starter" : "Log in to subscribe"}
                  </Button>
                )}
              </CardFooter>
            </Card>
